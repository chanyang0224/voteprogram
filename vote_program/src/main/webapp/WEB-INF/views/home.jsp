...
<body>
	...
	<main>
	<div id="main_area">
		<h1 id="main_text1" class="main_text">
			<span class="highlight">총회대의원 </span><span class="hightlight2">투표</span>에
		</h1>
	...
	<footer>
		<div id="logo_and_name">
			...
			<div class="names">
				<table class="tbbox">
					<td class="names_td"><span id="name1" class="name">기독교대한성결교회</span>
						<span id="name2" class="name">서울중앙지방회</span></td>
				</table>
			</div>
		</div>
	</footer>
	<script type="text/javascript">
		...
		var test, test1
		function myFunction() {
			var myStart = setTimeout(function() {
				test = $('.triangle');
				test1 = $('.rect');
			...
			var myStart2 = setTimeout(function() {
				test.animate({
					opacity : "0"
				}, 1000);
				test1.animate({
